...
project = u'llvmpy'
copyright = u'Mahadevan R (2008-2010), Continuum Analytics (2012)'
...
html_sidebars = {
   '**': ['gse.html', 'sidebar_versions.html', 'sidebar_links.html'],
...
latex_documents = [
  ('toc', 'llvmpy.tex', u'llvmpy Documentation',
...
man_pages = [
    ('toc', 'llvmpy', u'llvmpy Documentation',
